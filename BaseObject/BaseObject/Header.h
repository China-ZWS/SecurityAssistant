 ...
 *  @brief  与蓝色导航条一样的颜色
 */
#define CustomBlue RGBA(66, 161, 252, 1) //与蓝色导航条一样的颜色
#define CustomRed RGBA(177, 24, 23, 1) //与蓝色导航条一样的颜色
#define NavColor RGBA(66, 161, 252, 1)
#define CustomGreen RGBA(137,177,50,1) //绿色下载
#define CustomGray RGBA(150, 150, 150, 1) // 灰色
#define CustomBlack [UIColor darkGrayColor]
 //自定义黑色
