//
//  WaitHandledDangerDetailsResultTableViewCell.m
//  SecurityAssistant
//
...
@implementation WaitHandledDangerDetailsResultTableViewCell
...
-(void)layoutSubviews{
    _txtProcessMark.font = [UIFont systemFontOfSize:17];
    _txtProcessMark.textColor = [UIColor lightGrayColor];
}
