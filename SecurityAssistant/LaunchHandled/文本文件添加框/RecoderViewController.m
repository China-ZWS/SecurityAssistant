...
#define TIME_WIDTH (SCREEN_WIDTH/3)
...
#define RECORDBUTTON_WIDTH (SCREEN_WIDTH/4)
...
#define PLAYBUTTON_WIDTH SCREEN_WIDTH/5
...
- (void)initializeUI {
    ...
    recordAgainLabel = [[UILabel alloc] initWithFrame:CGRectMake(PLAYBUTTON_X+PLAYBUTTON_WIDTH+10, PLAYBUTTON_Y+PLAYBUTTON_HEIGHT, PLAYBUTTON_WIDTH+10, NAVBAR_HEIGHT)];
...
- (void)transformCAFToMP3 {
    ...
    @finally {
       ...
       if (self.AVRecoderSuncessBlock) {
           NSString *recoderstring=[NSString stringWithFormat:@"%@",audioFileSavePath];
        self.AVRecoderSuncessBlock(self,recoderstring);
